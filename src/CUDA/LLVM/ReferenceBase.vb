...
Namespace LLVM
	...
	Public MustInherit Class ReferenceBase
		Implements Global.System.IEquatable(Of Global.LLVM.ReferenceBase)
		...
		Public Shared Widening Operator CType(reference As Global.LLVM.ReferenceBase) As Global.System.IntPtr
			Return reference.reference
		End Operator

		' Token: 0x060000F3 RID: 243 RVA: 0x00003539 File Offset: 0x00001739
		Public Overloads Function Equals(other As Global.LLVM.ReferenceBase) As Boolean Implements System.IEquatable(Of LLVM.ReferenceBase).Equals
		...
		Public Overrides Overloads Function Equals(obj As Object) As Boolean
			Return Me.Equals(TryCast(obj, Global.LLVM.ReferenceBase))
		End Function
