...
Namespace LLVM.Interop
	...
	Public Class ClrInterop
		...
		Public Function GetDelegate([function] As [Function], delegateType As Global.System.Type, [module] As [Module], Optional debug As Boolean = False) As Global.System.[Delegate]
		...
		Friend Class Managed
			...
			Public Sub New()
				Me.[module] = Global.System.AppDomain.CurrentDomain.DefineDynamicAssembly(New Global.System.Reflection.AssemblyName() With { .Version = New Global.System.Version(1, 0), .Name = Interop.ClrInterop.Managed.GenerateIdentifier() }, Global.System.Reflection.Emit.AssemblyBuilderAccess.Run).DefineDynamicModule("DelegateTypes")
			End Sub
			...
			Friend Function Unwrap(wrapped As Global.System.[Delegate], delegateType As Global.System.Type, debug As Boolean) As Global.System.[Delegate]
				...
				Dim parameterExpression As Global.System.Linq.Expressions.ParameterExpression = If(Interop.ClrInterop.Managed.NeedsReturnWrapping(method.ReturnType), Global.System.Linq.Expressions.Expression.Variable(method.ReturnType, "retval"), Nothing)
				Dim <>9__4_ As Global.System.Func(Of Global.System.Reflection.ParameterInfo, Global.System.Linq.Expressions.ParameterExpression) = Interop.ClrInterop.Managed.<>c.<>9__4_0
			...
			Public Function WrapDelegateType(delegateType As Global.System.Type) As Global.System.Type
				...
				Dim parameters As Global.System.Collections.Generic.IEnumerable(Of Global.System.Reflection.ParameterInfo) = method.GetParameters()
				Dim <>9__5_ As Global.System.Func(Of Global.System.Reflection.ParameterInfo, Global.System.Type) = Interop.ClrInterop.Managed.<>c.<>9__5_0
				...
				Dim <>9__5_2 As Global.System.Func(Of Global.System.Type, Global.System.Type) = Interop.ClrInterop.Managed.<>c.<>9__5_1
				...
				Dim returnType As Global.System.Type = Interop.ClrInterop.Managed.WrapDelegateReturnType(method.ReturnType, list, returnByRef)
		...
		Friend Class Native
			...
			Public Function Wrap([function] As [Function], [module] As [Module], debug As Boolean) As [Function]
				...
				Dim function2 As [Function] = [module].CreateFunction(Global.System.Guid.NewGuid().ToString().Replace("-", ""), type2)
			...
			Friend Function WrapFunctionType(originalType As FunctionType) As FunctionType
				Dim list As Global.System.Collections.Generic.List(Of Type) = originalType.ArgumentTypes.[Select](AddressOf Me.WrapArg).ToList()
				Dim flag As Boolean
			...
			Private Shared Function WrapCall([function] As [Function], wrapper As [Function], gen As InstructionBuilder) As [Call]
				...
				Dim list As Global.System.Collections.Generic.List(Of Value) = New Global.System.Collections.Generic.List(Of Value)()
			...
			Private Shared Function WrapReturnType(originalType As FunctionType, wrapperArgs As Global.System.Collections.Generic.List(Of Type), <System.Runtime.InteropServices.OutAttribute()> ByRef returnByRef As Boolean) As Type
				Dim kind As TypeKind = originalType.ReturnType.Kind
