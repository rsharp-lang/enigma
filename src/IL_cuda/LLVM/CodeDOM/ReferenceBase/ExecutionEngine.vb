...
Namespace LLVM
    ...
    Public Class ExecutionEngine : Inherits ReferenceBase
        ...
        '			lazyFunctionLoader = Threading.Interlocked.CompareExchange(Of LazyFunctionLoader)(Me._LazyLoad, value2, lazyFunctionLoader2)
        '		Loop While lazyFunctionLoader IsNot lazyFunctionLoader2
        '	End AddHandler
        '	RemoveHandler(value As LazyFunctionLoader)
        '		Dim lazyFunctionLoader As LazyFunctionLoader = Me._LazyLoad
        '		Dim lazyFunctionLoader2 As LazyFunctionLoader
        '		Do
        '			lazyFunctionLoader2 = lazyFunctionLoader
