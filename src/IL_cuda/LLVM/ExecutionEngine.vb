...
Namespace LLVM
	...
	Public Class ExecutionEngine
		...
		Private Shared Function Create(target As [Module]) As Global.System.IntPtr
		...
		Public Function GetPointer([global] As GlobalValue) As Global.System.IntPtr
			...
			If kind <> TypeKind.Void Then
				Select Case kind
					...
					Case TypeKind.Pointer
						Return New LayoutInfo(Global.System.IntPtr.Size * 8)
				End Select
		...
		Public Custom Event LazyLoad As LazyFunctionLoader
			...
			AddHandler
				...
				Do
					...
					Dim value2 As LazyFunctionLoader = CType(Global.System.[Delegate].Combine(lazyFunctionLoader2, value), LazyFunctionLoader)
					lazyFunctionLoader = Global.System.Threading.Interlocked.CompareExchange(Of LazyFunctionLoader)(Me.LazyLoad, value2, lazyFunctionLoader2)
			...
			RemoveHandler
				...
				Do
					lazyFunctionLoader2 = lazyFunctionLoader
					Dim value2 As LazyFunctionLoader = CType(Global.System.[Delegate].Remove(lazyFunctionLoader2, value), LazyFunctionLoader)
					lazyFunctionLoader = Global.System.Threading.Interlocked.CompareExchange(Of LazyFunctionLoader)(Me.LazyLoad, value2, lazyFunctionLoader2)
				Loop While lazyFunctionLoader IsNot lazyFunctionLoader2
			End RemoveHandler
		End Event
		...
		Private Function OnLazyLoad(name As String) As Global.System.IntPtr
			...
			For i As Integer = 0 To invocationList.Length - 1
				Dim intPtr As Global.System.IntPtr = CType(invocationList(i), LazyFunctionLoader)(name)
